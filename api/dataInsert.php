    ...
    $startSubmit = $DecodedData['startSubmit'];
    $endSubmit = $DecodedData['endSubmit'];
    ...
    //echo gettype($hourSubmit); // null

    //  echo gettype($test);


    // problem decodedata cannot be accessed/ type?
